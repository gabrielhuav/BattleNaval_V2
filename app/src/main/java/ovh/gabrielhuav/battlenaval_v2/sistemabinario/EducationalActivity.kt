...
class EducationalActivity : AppCompatActivity() {
    ...
    private val fragments = listOf(
        NumerationSystemFragment(),
        BinarySystemFragment(),
        BinaryConversionFragment(),
        BinarySwitchesFragment(),
        DecimalToBinaryExplanationFragment(),
        DecimalToBinaryFragment()
    )
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val pagerAdapter = EducationalPagerAdapter(this, fragments)
